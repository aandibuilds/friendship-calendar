    ...
    <div className="view">
      ...
      <div className="friends-grid">
        {sorted.length
          ...
          : <div className="empty-state"><div className="empty-icon">👋</div><div className="empty-title">No friends here</div><div className="empty-sub">Hit "+ Add friend" to start.</div></div>
        }
      </div>
    </div>
  );
